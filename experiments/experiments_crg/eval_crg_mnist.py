...
Usage:
    python experiments_crg/eval_crg_mnist.py --weights experiments_crg/r001/crg_mnist_latest.npz
    python experiments_crg/eval_crg_mnist.py --weights experiments_crg/r001/crg_mnist_latest.npz --template-count 50
"""
